...
public class JTreeRightClickDemo2 extends JFrame {
    ...
    public Image getImage(String fileName) {
        ...
        try {
            ...
            Logger.getLogger(JTreeRightClickDemo2.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                fis.close();
            } catch (IOException ex) {
    ...
    class TreeAddViewMenuEvent implements ActionListener {
        ...
        private JTreeRightClickDemo2 adaptee;

        public TreeAddViewMenuEvent(JTreeRightClickDemo2 adaptee) {
    ...
    class TreeDeleteViewMenuEvent implements ActionListener {
        ...
        public TreeDeleteViewMenuEvent(JTreeRightClickDemo2 adaptee) {
            this.adaptee = adaptee;
        }
...
class TreeModifyViewMenuEvent implements ActionListener {
    ...
    public TreeModifyViewMenuEvent(JTreeRightClickDemo2 adaptee) {
        this.adaptee = adaptee;
    }
...
class TreePopMenuEvent implements MouseListener {
    ...
    public TreePopMenuEvent(JTreeRightClickDemo2 adaptee) {
        this.adaptee = adaptee;
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            JTreeRightClickDemo2 userframe = new JTreeRightClickDemo2();
